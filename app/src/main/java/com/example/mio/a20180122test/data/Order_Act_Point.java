...
public class Order_Act_Point {
    ...
    public Order_Act_Point(int _id_Order_Act,long Order_ID,int Order_Act_ID, String Order_Act,int Order_Act_Point){
    ...
    public Order_Act_Point(long Order_ID,int Order_Act_ID,String Order_Act,int Order_Act_Point){
        this.Order_ID= Order_ID;
        this.Order_Act_ID=Order_Act_ID;
        this.Order_Act=Order_Act;
        this.Order_Act_Point=Order_Act_Point;
